...
def geocode_address(address: str) -> dict:
    ...
    if lat is None or lon is None:
        print("  [INFO] No API keys found, falling back to mock geocoder...")
        offset = (hash(address) % 1000) / 100000.0 if address else 0
        lat, lon, display_address = 13.0835 - offset, 80.2700 + offset, address
